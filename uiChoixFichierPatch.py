...
class CheckboxWindowFile(QDialog):
    def __init__(self):
        ...
        nom_checkboxes = [concat_listes(listeFichier.LISTE_NOM_DESC_ID,
                                        listeFichier.LISTE_NOM_DESC_ID_COMPLEMENT),
                          concat_listes(listeFichier.LISTE_NOM_DLG_ID,
                                        listeFichier.LISTE_NOM_DLG_ID_COMPLEMENT),
                          concat_listes(listeFichier.LISTE_NOM_AUTRE_ID,
                                        listeFichier.LISTE_NOM_AUTRE_ID_COMPLEMENT)]
