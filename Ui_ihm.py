...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(642, 230)
        MainWindow.setMinimumSize(QtCore.QSize(642, 230))
        MainWindow.setMaximumSize(QtCore.QSize(642, 230))
        icon = QtGui.QIcon()
        ...
        self.pushButton_process.setGeometry(QtCore.QRect(260, 40, 75, 23))
        ...
        self.label_done.setGeometry(QtCore.QRect(340, 40, 291, 20))
        self.label_done.setObjectName("label_done")
        self.label_process = QtWidgets.QLabel(self.centralwidget)
        self.label_process.setGeometry(QtCore.QRect(340, 40, 291, 21))
        ...
        self.checkBox_exe = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_exe.setGeometry(QtCore.QRect(20, 200, 461, 17))
        self.checkBox_exe.setObjectName("checkBox_exe")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_exe.setText(_translate("MainWindow", "Update Launcher et ze1.exe"))
